...
/**
 * This is a class to perform frame in Salesforce Application
 * @author Sara.Danchevska
 *
 */

public class VlocityRulesFrame extends LoginButton {

	/**
	 * Automation script for creating new Vlocity Rule throught 'Vlocity Rules' tab in CPQ App
	 * @param args
