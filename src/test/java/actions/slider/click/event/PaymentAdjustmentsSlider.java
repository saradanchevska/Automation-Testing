...
/**
 * This is a class to perform slider in Salesforce Aplication
 * @author Sara.Danchevska
 *
 */

public class PaymentAdjustmentsSlider extends LoginButton {

	/**
	 * Automation script for creating a new Payment in 'Payment Adjustments'
	 * 
	 * @param args
